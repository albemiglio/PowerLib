...
public enum LegacyPotionAPI {
    ...
    INCREASE_DAMAGE_0("373:8201", 373, 8201, false, 0, false, PotionEffectType.STRENGTH, 3600, "Strength"),
    INCREASE_DAMAGE_1("373:8265", 373, 8265, false, 0, true, PotionEffectType.STRENGTH, 9600, "Strength"),
    INCREASE_DAMAGE_2("373:8233", 373, 8233, false, 1, false, PotionEffectType.STRENGTH, 1560, "Strength"),
    INCREASE_DAMAGE_3("373:8297", 373, 8297, false, 1, true, PotionEffectType.STRENGTH, 4800, "Strength"),
    INCREASE_DAMAGE_4("373:16393", 373, 16393, true, 0, false, PotionEffectType.STRENGTH, 2580, "Strength"),
    INCREASE_DAMAGE_5("373:16457", 373, 16457, true, 0, true, PotionEffectType.STRENGTH, 624, "Strength"),
    INCREASE_DAMAGE_6("373:16425", 373, 16425, true, 1, false, PotionEffectType.STRENGTH, 1284, "Strength"),
    INCREASE_DAMAGE_7("373:16489", 373, 16489, true, 1, true, PotionEffectType.STRENGTH, 3600, "Strength"),
    SLOW_0("373:8202", 373, 8202, false, 0, false, PotionEffectType.SLOWNESS, 1560, "Slowness"),
    SLOW_1("373:8266", 373, 8266, false, 0, true, PotionEffectType.SLOWNESS, 4800, "Slowness"),
    SLOW_2("373:16394", 373, 16394, true, 0, false, PotionEffectType.SLOWNESS, 1284, "Slowness"),
    SLOW_3("373:16458", 373, 16458, true, 0, true, PotionEffectType.SLOWNESS, 3600, "Slowness"),
    JUMP_0("373:8203", 373, 8203, false, 0, false, PotionEffectType.JUMP_BOOST, 3600, "Leaping"),
    JUMP_1("373:8267", 373, 8267, false, 0, true, PotionEffectType.JUMP_BOOST, 9600, "Leaping"),
    JUMP_2("373:8235", 373, 8235, false, 1, false, PotionEffectType.JUMP_BOOST, 1560, "Leaping"),
    JUMP_3("373:8299", 373, 8299, false, 1, true, PotionEffectType.JUMP_BOOST, 4800, "Leaping"),
    JUMP_4("373:16395", 373, 16395, true, 0, false, PotionEffectType.JUMP_BOOST, 2580, "Leaping"),
    JUMP_5("373:16459", 373, 16459, true, 0, true, PotionEffectType.JUMP_BOOST, 624, "Leaping"),
    JUMP_6("373:16427", 373, 16427, true, 1, false, PotionEffectType.JUMP_BOOST, 1284, "Leaping"),
    JUMP_7("373:16491", 373, 16491, true, 1, true, PotionEffectType.JUMP_BOOST, 3600, "Leaping"),
    HARM_0("373:8204", 373, 8204, false, 0, false, PotionEffectType.INSTANT_DAMAGE, 2400, "Harming"),
    HARM_1("373:8236", 373, 8236, false, 1, false, PotionEffectType.INSTANT_DAMAGE, 2400, "Harming"),
    HARM_2("373:16396", 373, 16396, true, 0, false, PotionEffectType.INSTANT_DAMAGE, 2400, "Harming"),
    HARM_3("373:16428", 373, 16428, true, 1, false, PotionEffectType.INSTANT_DAMAGE, 2400, "Harming"),

...
/**
 * Fired when a player interacts with a Nexo furniture.
 * This event wraps Nexo's native NexoFurnitureInteractEvent
 * so that downstream plugins don't need a direct Nexo dependency.
 */
@Getter
